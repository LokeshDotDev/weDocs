...
const CKEditorWrapper: React.FC<CKEditorWrapperProps> = ({ data, onChange, onSave, onComplete, fileId }) => {
    ...
    return (
        <div className="editor-container">
            ...
            <button onClick={onComplete} className="complete-button">Complete Editing</button>
        </div>
    );
};
